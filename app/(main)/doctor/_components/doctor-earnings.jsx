          ...
          <div className="bg-muted/20 p-4 rounded-lg border border-blue-900/20">
            <div className="flex items-center justify-between mb-3">
              ...
              {pendingPayout ? (
                <Badge
                  variant="outline"
                  className="bg-orange-900/20 border-orange-900/30 text-orange-400"
                >
                  PROCESSING
                </Badge>
              ) : (
            ...
            {pendingPayout ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                <div>
                  ...
                  <p className="text-foreground font-medium">{availableCredits}</p>
                </div>
                <div>
                    ...
                    <Badge
                      ...
                      className={
                        payout.status === "PROCESSED"
                          ...
                          : "bg-orange-900/20 border-orange-900/30 text-orange-400"
                      }
                    >
                      {payout.status}
                    </Badge>
